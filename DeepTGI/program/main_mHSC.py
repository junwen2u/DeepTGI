...
def prepare():
    ...
    extra_gene=pd.read_csv('/home/zhongle/zhongle/DGRNS/Dataset/scRNA-Seq/mHSC/ExpressionOrdered.csv')
    ...
    pair_label = pd.read_csv('~/zhongle/DGRNS/Dataset/scRNA-Seq/mHSC/GenePairListmESC.csv')
...
def cross_val(feature, label, event_num):
    ...
    for train_index, test_index in skf.split(feature, label):
        mat_GENIE3=pd.read_csv('~/test_R/pred_nets/GENIE3/GENIE3-mHSC-E.csv',sep=' ')
        mat_PPCOR=pd.read_csv('~/test_R/pred_nets/PPCOR/PPCOR-mHSC-E.csv',sep=' ')
        mat_PIDC=pd.read_csv('~/test_R/pred_nets/PIDC/PIDC-mHSC-E.csv',sep=' ')
        model = BERT(len(feature[0]), bert_n_heads, bert_n_layers, event_num)
        print('test_index',test_index) 
        label_all=np.array(pd.read_csv('/home/zhongle/zhongle/DGRNS/Dataset/scRNA-Seq/mHSC-E/GenePairListmHSC-E-Non-500-GPL.csv'))
