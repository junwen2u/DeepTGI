...
def prepare():
    def PCC(matrix):
        ...
        return matrix
    a = pd.read_csv('~/zhongle/DeepTTi/bulk_tf.csv')
    c = pd.read_csv('~/zhongle/DeepTTi/fc_tf.csv')
    #b = pd.read_csv('/home/zhongle/Data_test/tf_kegg_one_t.csv')
    d = pd.read_csv('~/zhongle/DeepTTi/bulk_gene.csv')
    f = pd.read_csv('~/zhongle/DeepTTi/fc_gene.csv')
    ...
    pair_label = pd.read_csv('~/zhongle/DeepTGi/label.csv')
